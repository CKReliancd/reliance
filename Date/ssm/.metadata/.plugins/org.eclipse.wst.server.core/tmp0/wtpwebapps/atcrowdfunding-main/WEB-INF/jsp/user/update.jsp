			  ...
			  <div class="panel-body">
				<form id="addUserForm">
				  <div class="form-group">
					<label for="loginacct">登陆账号</label><!-- 为了让单选框的名字也可以有点击选中功能，扩大点击范围 -->
            ...
            $("#updateBtn").click(function(){
            	...
            	$.ajax({
            		...
            		data:{
            			...
            			email:$("#email").val(),//小括号是jquery代码，属于前台的代码
            			id:"${user.id}"//大括号是EL表达式，属于Java程序为了和前台代码区分，放到双引号里去
            		},				   //${user.id}是在后台执行完了作为一个串赋值给id属性，提交给后台的时候
            						   //id的串在转换成Int eger
            		beforeSend:function(){
            			index = layer.load("正在修改数据",{time: 10*1000});
            			return true;
            		},
