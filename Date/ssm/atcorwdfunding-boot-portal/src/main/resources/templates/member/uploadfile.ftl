 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="uploadForm" style="margin-top:20px;" action="${APP_PATH}/member/uploadCertFile" method="post" enctype="multipart/form-data">
		  <#list certList as cert> 
			  <div class="form-group">
				<label for="exampleInputEmail1">${cert.name}</label>
				<input type="hidden" name="memberCertList[${cert_index}].certid" value="${cert.id}" class="form-control" >
				<input type="file"  name="memberCertList[${cert_index}].certFile" class="form-control" >
	            <br>
